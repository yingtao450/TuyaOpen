 ...
 */
OPERATE_RET tdd_sm16704pk_driver_open(DRIVER_HANDLE_T *handle, unsigned short pixel_num)
{
 ...
 * @return: success -> 0  fail -> else
 */
OPERATE_RET tdd_sm16704pk_driver_send_data(DRIVER_HANDLE_T handle, unsigned short *data_buf,
 ...
 * @return: success -> 0  fail -> else
 */
OPERATE_RET tdd_sm16704pk_driver_close(DRIVER_HANDLE_T *handle)
{
    OPERATE_RET ret = OPRT_OK;
    DRV_PIXEL_TX_CTRL_T *tx_ctrl = NULL;

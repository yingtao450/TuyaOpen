...
******************************macro define****************************
*********************************************************************/
#define DRV_SPI_SPEED 8000000 

#define DRVICE_DATA_0 0XC0 
...
OPERATE_RET tdd_sk6812_driver_open(DRIVER_HANDLE_T *handle, unsigned short pixel_num)
{
...
OPERATE_RET tdd_sk6812_driver_send_data(DRIVER_HANDLE_T handle, unsigned short *data_buf, unsigned int buf_len)
{
...
OPERATE_RET tdd_sk6812_driver_close(DRIVER_HANDLE_T *handle)
{
    OPERATE_RET ret = OPRT_OK;
    DRV_PIXEL_TX_CTRL_T *tx_ctrl = NULL;
 ...
 */
OPERATE_RET tdd_sk6812_driver_register(CHAR_T *driver_name, PIXEL_DRIVER_CONFIG_T *init_param)
{
    OPERATE_RET ret = OPRT_OK;

...
#if defined(AUDIO_CODEC_NAME) && (AUDIO_CODEC_NAME == 1)        
...
#if defined(BUTTON_NAME) && (BUTTON_NAME == 1)
...
#if defined(BUTTON_NAME_2) && (BUTTON_NAME_2 == 1)
    BUTTON_GPIO_CFG_T button_hw_cfg = {
        .pin   = BOARD_BUTTON_PIN,
        .level = BOARD_BUTTON_ACTIVE_LV,
        .mode  = BUTTON_TIMER_SCAN_MODE,
...
#if defined(LED_NAME) && (LED_NAME == 1)    

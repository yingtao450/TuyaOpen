...
// Here, the app_display.h file from the same directory is used,
// which is identical in content to apps/tuya.ai/your_chat_bot/include/app_display.h.
// Due to compilation issues, a copy was made here.
